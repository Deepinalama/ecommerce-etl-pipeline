...
df_users = df_users.drop(columns=['password','ssn','ein','crypto_coin','crypto_wallet','crypto_network'], errors='ignore')
...
df_product_reviews.to_sql('product_reviews', engine, if_exists='replace', index=False)
...
df_product_tags.to_sql('product_tags', engine, if_exists='replace', index=False)
print('product_tags loaded successfully')
